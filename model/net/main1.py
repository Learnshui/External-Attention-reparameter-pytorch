...
def train(param_set,model):
    ...
    gt_labels = get_gt_labels(os.path.join(param_set['imgdir'], test_batch[0], 'gt/segmentation-125/'))  # when evaluate
    ...
    for epoch in range(num_epochs+1):
        ...
        with open(save_dir + "/home/shuiyuanyuan/PA-ResSeg-main/validation_log.txt", "a") as f:
...
def get_liver_mask(pre_case,minz,maxz):
    ...
    gt_path = '/home/datacenter/ssd1/datasets/LiTS/raw_dataset/test/label'
...
if __name__ == '__main__':
    ...
    ini_file = '/home/shuiyuanyuan/PA-ResSeg-main/tr_param.ini'
