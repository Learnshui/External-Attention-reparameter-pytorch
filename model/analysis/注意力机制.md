...
### 17.2. 模型结构
<img width="758" alt="image" src="https://user-images.githubusercontent.com/63939745/188415823-f3c45fc7-e984-4206-a547-d183160c8714.png">

### 17.3. 简介
PSA首先进入通道分支，在重新分配权重值后，然后发送到空间分支，重新分配空间维度中的权重值。
